...
const guerrier =    new Character("Théophile Le Luisant",               40, 70, 0, 0, 0, 50, 100, 100, 80, false, false, false);
const mage =        new Character("Merlin Gros Baton",                  10, 10, 50, 30, 100, 50, 100, 100, 80, false, false, false);
const paladin =     new Character("Dartagnan Durex",                    30, 75, 20, 50, 100, 60, 100, 100, 80, false, false, false);
const barbare =     new Character("Marcel Le Pénètrepeau",              30, 10, 10, 10, 0, 30, 100, 100, 80, false, false, false);
const prêtre =      new Character("Jean De Pédolandie",                 20, 10, 30, 30, 100, 100, 100, 100, 80, false, false, false);
const voleur =      new Character("Marcus Le Voleur D'Innocence",       50, 50, 0, 10, 0, 80, 100, 100, 80, false, false, false);
