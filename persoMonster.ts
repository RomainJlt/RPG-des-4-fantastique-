...
export const Prêtre =      new Character("Jean De Pédolandie",                 20, 10, 0, 0, 100, 100, 100, 80, false, false, false);
export const Voleur =      new Character("Marcus Le Voleur D'Innocence",       50, 50, 0, 0, 80, 100, 100, 80, false, false, false);


const bucheron =    new Character("Paul La Grosse Poutre",              100, 100, 0, 0, 100, 100, 100, 80, false, false, false);
const scammer =     new Character("Axel Le Scammer De Mémés Baveuses",  100, 100, 0, 0, 100, 100, 100, 80, false, false, false);
const geek =        new Character("Romain Ultimement Nul",              100, 100, 0, 0, 100, 100, 100, 80, false, false, false);
const druide =      new Character("Najm L'Anaconda",                    100, 100, 0, 0, 100, 100, 100, 80, false, false, false);
const dieu =        new Character("Julien La Divinité",                 1000, 1000, 0, 0, 1000, 1000, 1000, 100, false, false, false);
